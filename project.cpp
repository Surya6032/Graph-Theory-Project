...
#include<bits/stdc++.h> 
#include <iostream> 
#include <unordered_map>   //Add this in your compiler seperately by putting -std=c++11 in the compiler settings if doesn't work text me
using namespace std; 
...
int main(){
   ...
   // g.dijsktraSSSP(1);
    ...
    //Sorry for using indian cities name but you can change them
    // With this method only we can implement the suggested friends code
    Graph<string> india;
    ...
    //india.printAdj();
    india.dijsktraSSSP("Amritsar");   //Node starts from here
